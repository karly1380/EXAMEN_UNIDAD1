...
<body style="background-color: #800080;color: pink">	
	<div class="container">	
...
<br>
	...
	<h3>" PRESENTACIÓN DE IMÁGENES TIPO - GOOGLE "</h3>
    </MARQUEE>
        ...
        <H5>Exámen Unidad 1 
        	<br>
        	Materia: Tópicos de Programación con MVC
        	<br>
            Alumna: Caudillo Cortés Karla Denisse
            <br>
		    Grupo:7S2
	    </H5>
	    </h2>
